<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:77:"/www/wwwroot/xf.xtqwe.top/web/../source/application/store/view/user/index.php";i:1631016882;s:74:"/www/wwwroot/xf.xtqwe.top/source/application/store/view/layouts/layout.php";i:1586309950;}*/ ?>
<!DOCTYPE html>
<html lang="en">
                                ...
                                <tr>
                                    ...
                                    <td class="am-text-middle">
                                        <div class="tpl-table-black-operation">
                                            ...
                                            <?php endif; if (checkPrivilege('user/grade')): ?>
                                            ...
                                            <div class="j-opSelect operation-select am-dropdown">
                                                ...
                                                <ul class="am-dropdown-content" data-id="<?= $item['user_id'] ?>">
                                                    ...
                                                    <?php endif; if (checkPrivilege('user.balance/log')): ?>
                                                        <li>
                                                            <a class="am-dropdown-item" target="_blank"
