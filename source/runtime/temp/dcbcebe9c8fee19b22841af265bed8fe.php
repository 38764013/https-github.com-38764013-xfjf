<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:90:"/www/wwwroot/sc.1m9.cn/web/../source/application/store/view/apps/navigation/index/edit.php";i:1631323902;s:71:"/www/wwwroot/sc.1m9.cn/source/application/store/view/layouts/layout.php";i:1586309950;s:87:"/www/wwwroot/sc.1m9.cn/source/application/store/view/layouts/_template/file_library.php";i:1586309950;}*/ ?>
<!DOCTYPE html>
<html lang="en">
                                ...
                                <div class="am-u-sm-10">
                                    <label class="am-radio-inline">
                                        <input type="radio" name="navigation[show_type]"
                                               value="10" data-am-ucheck  <?= $model['show_type'] == 10 ? 'checked' : '' ?>>
                                        小程序内链
                                    </label>
                                    <label class="am-radio-inline">
                                        <input type="radio" name="navigation[show_type]"
                                               value="20" data-am-ucheck <?= $model['show_type'] == 20 ? 'checked' : '' ?>>
                                        外链地址
                                    </label>
                                    <label class="am-radio-inline">
                                        <input type="radio" name="navigation[show_type]"
                                               value="30" data-am-ucheck <?= $model['show_type'] == 30 ? 'checked' : '' ?>>
                                        跳转小程序
                                    </label>
                                        ...
                                        <div class="am-form-file">
                                            ...
                                            <div class="uploader-list am-cf">
                                                <div class="file-item">
                                                    ...
                                                    <input type="hidden" name="navigation[image_id]"
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="text" class="tpl-form-input" name="navigation[url]"
                                           value="<?= $model['url'] ?>" placeholder="请输入跳转链接地址">
                                </div>
                            </div>
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="text" class="tpl-form-input" name="navigation[app_id]"
                                           value="<?= $model['app_id'] ?>" placeholder="请输入小程序APPID">
                                </div>
                            </div>
                            <div class="am-form-group">
