                ...
                <form id="my-form" class="am-form tpl-form-line-form" method="post">
                    <div class="widget-body">
                        <fieldset>
                            ...
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require"> 套餐金额 </label>
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="number" class="tpl-form-input" name="plan[money]"
                                           value="<?= $model['money'] ?>" placeholder="请输入套餐金额" required>
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require"> 搜题次数 </label>
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="number" class="tpl-form-input" name="plan[gift_money]"
                                           value="<?= $model['gift_money'] ?>" placeholder="请输入搜题次数" required>
                                </div>
                            </div>
                            <div class="am-form-group">
